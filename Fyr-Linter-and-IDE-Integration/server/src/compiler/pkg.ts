...
export class Package {
     ...
     */
    public loadSources(theCode:string) {
        if (this.isInternal) {
            return;
        }
     ...
     */
    public static checkTypesForPackages():any {
        let e=null
        try {
    ...
    public static initiliazeVariables()
        {
                Package.mainPackage=null
                Package.packagesByPath  = new Map<string, Package>();
                Package.packages=[]
